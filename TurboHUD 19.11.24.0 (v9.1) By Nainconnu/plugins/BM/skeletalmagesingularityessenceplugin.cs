...
namespace Turbo.Plugins.BM
{
    public class SkeletalMageSingularityEssencePlugin : BasePlugin, IInGameTopPainter
    {
        ...
        {
            base.Load(hud);
            FullBackgroundBrush = Hud.Render.CreateBrush(160, 0, 255, 0, 0);
			ReapersWrapsBackgroundBrush = Hud.Render.CreateBrush(160, 255, 165, 0, 0);
            NotFullBackgroundBrush = Hud.Render.CreateBrush(160, 255, 0, 0, 0);
